...
namespace Netco.ActionPolicyServices
{
	...
	public class ActionPolicyAsync
	{
		...
		public static SyntaxAsync< ExceptionHandler > From( Func< Exception, bool > doWeHandle )
		{
			...
			bool handler( Exception exception )
			{
				return doWeHandle( exception );
			}

			return Syntax.ForAsync( ( ExceptionHandler )handler );
		}
		...
		/// <returns>syntax</returns>
		public static SyntaxAsync< ExceptionHandler > Handle< TException >() where TException : Exception
		{
		...
		/// <returns>syntax</returns>
		public static SyntaxAsync< ExceptionHandler > Handle< TEx1, TEx2 >() where TEx1 : Exception where TEx2 : Exception
		{
		...
		/// <returns>syntax</returns>
		public static SyntaxAsync< ExceptionHandler > Handle< TEx1, TEx2, TEx3 >() where TEx1 : Exception where TEx2 : Exception where TEx3 : Exception
		{
