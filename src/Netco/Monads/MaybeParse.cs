...
namespace Netco.Monads
{
	...
	public static class MaybeParse
	{
		...
		public static Maybe< decimal > Decimal( string value, NumberStyles numberStyles, IFormatProvider formatProvider )
		{
		...
		public static Maybe< double > Double( string value, NumberStyles numberStyles, IFormatProvider formatProvider )
		{
		...
		{
			return Double( value, NumberStyles.Float | NumberStyles.AllowThousands, CultureInfo.InvariantCulture );
		}
		...
		{
			return int.TryParse( value, out var result ) ? result : Maybe< int >.Empty;
		}
		...
		public static Maybe< int > Int32( string value, NumberStyles numberStyles, IFormatProvider formatProvider )
		{
			return int.TryParse( value, numberStyles, formatProvider, out var result ) ? result : Maybe< int >.Empty;
		}
		...
		public static Maybe< long > Int64( string value, NumberStyles numberStyles, IFormatProvider formatProvider )
		{
		...
		public static Maybe< float > Single( string value, NumberStyles numberStyles, IFormatProvider formatProvider )
		{
		...
		/// </returns>
		/// <seealso cref="System.Single.TryParse(string,System.Globalization.NumberStyles,System.IFormatProvider,out float)" />
		public static Maybe< float > SingleInvariant( string value )
		{
			return Single( value, NumberStyles.Float | NumberStyles.AllowThousands, CultureInfo.InvariantCulture );
		}
	}
}